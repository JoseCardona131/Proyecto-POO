...
public class Ventana_graficos extends javax.swing.JDialog {
    ...
    //Variable para guardar los datos de las graficas
    private JFreeChart grafica;
    private Sistema_Sismos sistema = new Sistema_Sismos();

    public Ventana_graficos(java.awt.Frame parent, boolean modal, String tipo) {
        super(parent, modal);
        initComponents();
        
        switch(tipo){
            case "provincia":
                grafica = sistema.cantidad_sismos_provincia();
                break;
            case "origen":
        ...
        panel.setPreferredSize(new Dimension(625,415));
